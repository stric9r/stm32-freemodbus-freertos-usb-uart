 ...
 *   - PE0-PE7          Push-pull output, low speed — Modbus coil outputs
 *
...
void gpio_init(void)
{
  ...
  /*Configure GPIO pins : PE8 PE9 PE10 PE11 PE12 PE13 PE14 PE15 (unused) */
  ...
  /*Configure GPIO pins : PE0-PE7 (Modbus coil outputs) */
